...
Legally speaking, either a **clinical psychologist** or a **psychiatrist** can issue a GD certificate. The difference between the two is that a clinical psychologist is not a medical doctor and typically deals more with the therapy aspect of things, whereas a psychiatrist is a medical doctor who can legally prescribe medications and usually doesn't focus as much on the therapy aspect (though they often recommend it!). 
...
For me, the whole process took around 4 days, and I was issued the GD certificate by a clinical psychologist in just one session. The certificate cost me exactly ₹1,200, which included both the session and the issuance of the document (it's an online certificate, which is completely valid).
